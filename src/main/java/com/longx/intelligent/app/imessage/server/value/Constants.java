...
public class Constants {
    public static final String APP_NAME = "Apollo Server";
    ...
    public static final String[] IMESSAGE_ID_USER_INVALID_CONTENTS = {"imessage", "ichat", "long", "apollo"};
    public static final String[] GROUP_CHANNEL_ID_USER_INVALID_CONTENTS = {"imessage", "ichat", "long", "apollo"};
    ...
    public static final String CONFIG_JSON_FILE_NAME = "apollo-server-properties.json";
